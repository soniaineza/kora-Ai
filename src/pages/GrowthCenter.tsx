            ...
            <div className="space-y-5">
              <div>
                ...
                <select
                  ...
                  className="w-full p-2.5 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-kora-500/20 focus:border-kora-500 outline-none text-sm text-gray-900"
                >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full p-2.5 pl-12 bg-gray-50 border border-gray-200 rounded-lg focus:ring-2 focus:ring-kora-500/20 focus:border-kora-500 outline-none text-sm text-gray-900"
              ...
              <button
                ...
                className="w-full py-2.5 bg-gradient-to-r from-kora-500 to-kora-600 hover:from-kora-600 hover:to-kora-700 text-white font-medium rounded-lg shadow-glow transition-all flex items-center justify-center gap-2 text-sm mt-4"
              >
          ...
          >
            <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-green-800">
                  We've created a comprehensive campaign to help your {businessType} achieve &quot;{goal}&quot; with a budget of {budget} RWF.
                </p>
              </div>
              <button
                onClick={() => setStep('input')}
                className="shrink-0 px-3 py-1.5 bg-white border border-green-200 text-green-700 rounded-lg text-xs font-medium hover:bg-green-50 transition-colors"
              >
                Start Over
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-card">
                ...
                <button className="w-full py-2 bg-gray-50 hover:bg-gray-100 text-gray-700 text-sm font-medium rounded-lg transition-colors">
                  View All Designs
                </button>
              </div>
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-5 shadow-card">
                ...
                <div className="bg-emerald-50 border border-emerald-100 rounded-lg p-3 mb-3">
                  <p className="text-xs text-gray-800 whitespace-pre-line">
                    ☕ *Hey Coffee Lovers!* 👋 Need a mid-week boost? We've got you covered! Show this message at Sunny Cafe today and get *20% OFF* any pastry when you buy a large coffee. 🥐☕ Tap here to see our menu: 👉 kora.ai/sunnycafe See you soon! ✨
                  </p>
                </div>
                <div className="flex gap-2">
                  ...
                  <button className="px-3 py-2 bg-gray-50 hover:bg-gray-100 text-gray-700 text-sm font-medium rounded-lg transition-colors">
                    Edit
                  </button>
                </div>
              </div>
              ...
              <div className="md:col-span-2 bg-white rounded-xl border border-gray-100 p-5 shadow-card">
                ...
                <div className="space-y-3">
                  {[
                    { day: 'Mon', title: 'Launch Teaser on Instagram', desc: 'Post the first AI generated poster to build anticipation for the weekend offer.' },
                    { day: 'Wed', title: 'Send WhatsApp Broadcast', desc: 'Send the generated message to your top 100 customers with the special link.' },
                    { day: 'Fri', title: 'Run Facebook Ad (Budget: 10k RWF)', desc: 'Boost the promotional video targeting people within 5km of your location.' },
                  ].map((item) => (
